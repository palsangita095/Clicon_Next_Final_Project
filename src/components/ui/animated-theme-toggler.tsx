...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "flex items-center justify-center rounded-md transition-colors -mr-2 md:mr-0",
        
        className,
      )}
      {...props}
    >
      {/* Remove any 'size' props from the icons. 
        Use h-4 w-4 (16px) or h-5 w-5 (20px) for a standard, 
        clean look that matches typical icon buttons. 
      */}
      {isDark ? (
